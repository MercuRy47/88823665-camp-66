    ...
    <div class="register-box">
      ...
      <div class="card">
        <div class="card-body register-card-body">
          <p class="register-box-msg">Edit your information</p>
          <form action="{{  url('/user') }}" method="post" id="myForm">
            @csrf
            @method('PUT')
            ...
            {{-- <div class="row">
              ...
              <div class="col-12">
                <div class="d-flex justify-content-between gap-2">
                  ...
                  <button type="button" class="btn btn-danger" onclick="document.getElementById('myForm').reset();">Reset</button>
                </div>
              </div>
              <!-- /.col -->
            </div>
